...
enum LoginDatabaseStatements
{
    ...
    */
    ...
    // Future account wide statements

    LOGIN_DEL_CHAR_ACHIEVEMENT,
    LOGIN_DEL_CHAR_ACHIEVEMENT_PROGRESS,
    LOGIN_INS_CHAR_ACHIEVEMENT,
    LOGIN_DEL_CHAR_ACHIEVEMENT_PROGRESS_BY_CRITERIA,
    LOGIN_INS_CHAR_ACHIEVEMENT_PROGRESS,

    LOGIN_SEL_ACCOUNT_BATTLE_PETS,
    LOGIN_DEL_ACCOUNT_BATTLE_PET,
    LOGIN_INS_ACCOUNT_BATTLE_PET,
    LOGIN_SEL_ACCOUNT_BATTLE_PET_SLOTS,
    LOGIN_DEL_ACCOUNT_BATTLE_PET_SLOTS,
    LOGIN_INS_ACCOUNT_BATTLE_PET_SLOTS,
