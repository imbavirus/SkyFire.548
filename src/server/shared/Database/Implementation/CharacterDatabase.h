...
enum CharacterDatabaseStatements
{
    ...
    */
    ...
    CHAR_DEL_CHAR_ACHIEVEMENT,  // Moving to auth DB
    CHAR_DEL_CHAR_ACHIEVEMENT_PROGRESS, // Moving to auth DB
    CHAR_INS_CHAR_ACHIEVEMENT, // Moving to auth DB
    CHAR_DEL_CHAR_ACHIEVEMENT_PROGRESS_BY_CRITERIA, // Moving to auth DB
    CHAR_INS_CHAR_ACHIEVEMENT_PROGRESS, // Moving to auth DB
    ...
    CHAR_SEL_ACCOUNT_BATTLE_PETS, // Moving to auth DB
    CHAR_DEL_ACCOUNT_BATTLE_PET, // Moving to auth DB
    CHAR_INS_ACCOUNT_BATTLE_PET, // Moving to auth DB
    CHAR_SEL_ACCOUNT_BATTLE_PET_SLOTS, // Moving to auth DB
    CHAR_DEL_ACCOUNT_BATTLE_PET_SLOTS, // Moving to auth DB
    CHAR_INS_ACCOUNT_BATTLE_PET_SLOTS, // Moving to auth DB
